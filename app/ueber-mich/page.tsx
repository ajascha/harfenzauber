          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="flex flex-col justify-center space-y-6">
              ...
              <p className="max-w-[600px] text-muted-foreground text-lg">
                ...
                und Leidenschaft für die Harfe bringe ich jeden Schüler dazu, das
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className="prose prose-neutral max-w-none prose-a:text-primary hover:prose-a:opacity-80">
            ...
            <p className="text-muted-foreground mb-4">
              Die Harfe begleitet mich seit vielen Jahren auf meinem musikalischen
              Weg. Mit ihrem sanften Klang schaffe ich eine besondere Atmosphäre,
              die Menschen berührt und entspannt.
            </p>
            <p className="text-muted-foreground mb-4">
              Als Harfenlehrerin habe ich die Freude, Menschen jeden Alters dabei
              zu begleiten, dieses wundervolle Instrument zu entdecken. Besonders
              die Arbeit mit Kindern liegt mir am Herzen – ihre Begeisterung und
              ihre natürliche Neugier machen jede Unterrichtsstunde zu etwas
              Besonderem.
            </p>
